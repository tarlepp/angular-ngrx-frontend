...
Some benchmark about `Docker for Mac` versus `Docker for Mac Edge` can be found in this
[Docker for Mac performance benchmark article](https://medium.com/@somwhatparanoid/tweaking-docker-for-mac-performance-for-php-and-symfony-b63f3395a1da)
