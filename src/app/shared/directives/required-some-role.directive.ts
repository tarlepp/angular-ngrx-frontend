 ...
 *
 * Usage example;
 *  <div *appRequiredSomeRole="['FOO', 'BAR', 'FOO_BAR']"> ... </div>
 */
@Directive({
  selector: '[appRequiredSomeRole]',
})

export class RequiredSomeRoleDirective implements OnInit, OnDestroy {
  @Input('appRequiredSomeRole') public role: Array<Role | string>;
